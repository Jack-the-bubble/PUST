...
\begin{figure}[tb]
	\centering
	\tikzsetnextfilename{DMC/DMC_D=182_N=180_Nu=180_L=1}
	\begin{tikzpicture}
	...
	\addplot[color=blue,semithick] file {../DMC/Y__DMC_D=182_N=180_Nu=180_L=1.txt};
	...
	file {../DMC/U__DMC_D=182_N=180_Nu=180_L=1.txt};
	\end{groupplot}
	\end{tikzpicture}
\end{figure}
